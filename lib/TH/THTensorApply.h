...
{ \
  ...
  LONG_PTR *TENSOR1##_counter = NULL; \
  LONG_PTR TENSOR1##_stride = 0, TENSOR1##_size = 0, TENSOR1##_dim = 0, TENSOR1##_i, TENSOR1##_n; \
  TYPE2 *TENSOR2##_data = NULL; \
  LONG_PTR *TENSOR2##_counter = NULL; \
  LONG_PTR TENSOR2##_stride = 0, TENSOR2##_size = 0, TENSOR2##_dim = 0, TENSOR2##_i, TENSOR2##_n; \
  TYPE3 *TENSOR3##_data = NULL; \
  LONG_PTR *TENSOR3##_counter = NULL; \
  LONG_PTR TENSOR3##_stride = 0, TENSOR3##_size = 0, TENSOR3##_dim = 0, TENSOR3##_i, TENSOR3##_n; \
...
\
  ...
  { \
    ...
    TENSOR1##_counter = (LONG_PTR*)THAlloc(sizeof(LONG_PTR)*(TENSOR1##_dim+1)); \
...
\
    ...
    TENSOR2##_counter = (LONG_PTR*)THAlloc(sizeof(LONG_PTR)*(TENSOR2##_dim+1)); \
...
\
    ...
    TENSOR3##_counter = (LONG_PTR*)THAlloc(sizeof(LONG_PTR)*(TENSOR3##_dim+1)); \
...
{ \
  ...
  LONG_PTR *TENSOR##_counter = NULL; \
  LONG_PTR TENSOR##_stride = 0, TENSOR##_size = 0, TENSOR##_dim = 0, TENSOR##_i; \
  int TH_TENSOR_APPLY_hasFinished = 0; \
\
...
\
    ...
    TENSOR##_counter = (LONG_PTR*)THAlloc(sizeof(LONG_PTR)*(TENSOR##_dim+1)); \
